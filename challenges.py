...
#** Updated this to my database URI
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://priscillamnunez@localhost/moviedb"
...
def result():
    ...
    if form.validate_on_submit():
        ...
        if d:
            ...
            d = Director(directorName = director_name)       #** The else, add, commit is if the Director does NOT exist
            db.session.add(d)
            db.session.commit()
